...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Xeltschmerz",
      };
  ...
  const projectUrl = `https://djabenk.net/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — DJabenk</title>
        <meta
          name="description"
          content={
            project.Description
